...
<div id="product_page_wrapper">
	<div class="row">
		...
		<div class="nine columns">
			...
			$result1 = mysqli_query($conn,"SELECT * FROM `product`,`brand`where product_brand_id=brand_id AND product_trash = '0' ORDER BY `brand`.`brand_name` ASC limit $page1,16");
			...
			$product = mysqli_query($conn,"SELECT * FROM `product`,`brand`where product_brand_id=brand_id AND product_trash = '0' ORDER BY `brand`.`brand_name` ASC");
			...
			{ ?><div class="pagination">
					<a href="member_sorting_brand_asc.php?page=<?php echo $b; ?>"><?php echo $b. " " ?></a>
				</div><?php
			}	
			?>	
			</div>
