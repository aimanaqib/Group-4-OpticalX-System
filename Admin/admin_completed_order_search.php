...
?>
<title>Search Completed Order</title>
				...
				<form name="product_search" action="admin_completed_order_search.php" method="post">
					<ul class="search_wrapper_product">
						...
						<li class="product_top_search_right">
							<button type="submit" name="search_btn" class="completed_order_search_button">
...
{ 
   $search = $_POST['search'];
   $query = mysqli_query($conn, "select * from purchase,shopping_cart,member where ((purchase_shopping_cart_id = shopping_cart_id AND shopping_cart_member_id = member_id AND purchase_status = 'delivered') OR (purchase_shopping_cart_id = shopping_cart_id AND shopping_cart_member_id = member_id AND purchase_status = 'cancelled')) And ((purchase_id like '%$search%') or (member_id like '%$search%') or (purchase_time like '%$search%') or (purchase_status like '%$search%'))");
