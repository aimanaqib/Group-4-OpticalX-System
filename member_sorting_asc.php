...
<div id="product_page_wrapper">
	<div class="row">
		...
		<div class="nine columns">
			...
			$result1 = mysqli_query($conn,"select * from product where product_trash='0' ORDER BY `product`.`product_name` asc limit $page1,16");
			...
			$product = mysqli_query($conn,"select * from product where product_trash='0' ORDER BY `product`.`product_name` asc");
			...
			{ ?><div class="pagination">
					<a href="member_sorting_asc.php?page=<?php echo $b; ?>"><?php echo $b. " " ?></a>
				</div><?php
			}	
			?>	
			</div>
