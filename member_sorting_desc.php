...
<div id="product_page_wrapper">
	<div class="row">
		...
		<div class="nine columns">
			...
			$result1 = mysqli_query($conn,"select * from product where product_trash='0' ORDER BY `product`.`product_name` desc limit $page1,16");
			...
			$product = mysqli_query($conn,"select * from product where product_trash='0' ORDER BY `product`.`product_name` desc");
			...
			{ ?><div class="pagination">
					<a href="member_sorting_desc.php?page=<?php echo $b; ?>"><?php echo $b. " " ?></a>
				</div><?php
			}	
			?>	
			</div>
